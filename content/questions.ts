...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    verdict: 'reject',
    truth: 'เหตุผลเดียวที่เป็ดมีคือ "ป้าดาพูดด้วยความมั่นใจ" ซึ่งไม่ใช่หลักฐานสักอย่าง ความมั่นใจของคนพูด กับความถูกต้องของสิ่งที่พูด เป็นคนละเรื่องกัน',
  ...
  },
  {
    ...
    verdict: 'reject',
    truth: 'เหงื่อออกเพราะความเผ็ดไปกระตุ้นตัวรับความร้อน ร่างกายจึงระบายความร้อนออกมา ไม่เกี่ยวกับไขมันเลย เป็ดเห็นสองอย่างมาคู่กัน แล้วเดาเอาว่าอันหนึ่งเป็นสาเหตุของอีกอัน',
  ...
  },
  {
    ...
    verdict: 'reject',
    truth: 'บนถ้วยเขียนแค่ว่าเนื้อเนียน ไม่ได้บอกวิธีกินสักคำ เป็ดเติม "ต้องกลืนเลย" ขึ้นมาเองจากคำโฆษณาสองคำ นี่คือการสรุปเกินกว่าที่ข้อมูลบอก',
  ...
  // ── Act 3 · ฟังดูน่าเชื่อ ไม่ใช่หลักฐาน ───────────────────────────
  {
    ...
    verdict: 'pass',
    truth: 'จริง หัวใจสองดวงสูบเลือดไปที่เหงือก อีกดวงสูบไปเลี้ยงทั้งตัว ข้อนี้ฟังดูเหลือเชื่อที่สุดในเกม แต่เป็นข้อที่ตรวจสอบได้ชัดที่สุด',
  ...
  },
  {
    ...
    verdict: 'reject',
    truth: 'วิวนับแค่ว่ามีคนกดดู ไม่ได้บอกว่าดูจบ ดูเพราะชอบ หรือดูเพราะกำลังโดนด่ากันทั้งเมือง ตัวเลขจริง แต่มันไม่ได้แปลว่าอย่างที่เป็ดสรุป',
  ...
  },
  {
    ...
    verdict: 'reject',
    truth: 'ไม่มีหลักฐานว่า Einstein เคยพูดประโยคนี้ เป็นคำคมที่ถูกเอาไปแปะชื่อเขาทีหลัง แล้วแพร่ต่อจนคนจำว่าเป็นของเขา ชื่อที่ถูกอ้างมีอยู่จริง ความเชื่อมโยงไม่มี',
